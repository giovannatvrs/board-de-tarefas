...
import static br.com.dio.demo.persistence.converter.OffsetDateTimeConverter.toOffsetDateTime;
...
public class CardDAO {
    ...
    public CardEntity insert(final CardEntity entity) throws SQLException {
        if (entity.getBoardColumn() == null) {
            throw new SQLException("BoardColumn não pode ser null ao inserir Card.");
        }
